...
const char* WS_URL    = "ws://10.19.179.237:8765";
...
const int L_FWD     = 95;  // neutral + 6
const int L_BACK    = 86;  // neutral - 4

// Right: neutral ~88, reversed direction
const int R_NEUTRAL = 88;
const int R_FWD     = 84;  // neutral - 4 (forward)
const int R_BACK    = 93;  // neutral + 5 (backward)

// ===== Tick (nudge) tuning =====
// Forward/back nudges
const unsigned long MOVE_ON_MS  = 70;   // move pulse duration
const unsigned long MOVE_OFF_MS = 120;  // pause between pulses

// Left/right nudges
const unsigned long TURN_ON_MS  = 60;   // turn pulse duration
const unsigned long TURN_OFF_MS = 140;  // pause between pulses
