...
const int L_FWD     = 100;  // neutral + 6
const int L_BACK    = 80;  // neutral - 4

// Right: neutral ~88, reversed direction
const int R_NEUTRAL = 90;
const int R_FWD     = 86;  // neutral - 4 (forward)
const int R_BACK    = 94;  // neutral + 5 (backward)
